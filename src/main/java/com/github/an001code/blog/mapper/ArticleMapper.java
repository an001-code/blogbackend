...
public interface ArticleMapper {
    ...
    @Select("select a.*,t.tag_name from article a left join tag t on a.tag_id = t.tag_id where a.status = 1 and a.is_deleted = 0")
    ...
    Long countArticles(ArticleQuery articleQuery);
}
